...
const BababotWS = {
  ...
  hashes: [
    0xffffff, 0xc4c4c4, 0x888888, 0x555555, 0x222222, 0x0, 0x6600, 0x22b14c,
    0x2be01, 0x51e119, 0x94e044, 0xfbff5b, 0xe5d900, 0xe6be0c, 0xe59500,
    0xa06a42, 0x99530d, 0x633c1f, 0x6b0000, 0x9f0000, 0xe50000, 0xff3904,
    0xbb4f00, 0xff755f, 0xffc49f, 0xffdfcc, 0xffa7d1, 0xcf6ee4, 0xec08ec,
    0x820080, 0x5100ff, 0x20763, 0xea, 0x44bff, 0x6583cf, 0x36baff, 0x83c7,
    0xd3dd, 0x45ffc8,
  ],
...
class BababotFactory {
  ...
  async handleUI() {
    ...
    this.Menu = {
      ...
      canvas_display: query('#Bababot_canvas'),
      x: $('#Bababot_x'),
      y: $('#Bababot_y'),
      width: $('#Bababot_width'),
